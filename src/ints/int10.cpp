...
void INT10_Init(Section* /*sec*/) {
	...
	if (svgaCard == SVGA_PS55) {
		//This routine is replaced by MODE command.
		//no need to mask other bits here
		//IO_Write(0x94, 0xDF);//enter setup VGA
		//IO_Write(0x102, 0x00);//kill VGA
		//IO_Write(0x94, 0xFF);//exit setup VGA
		//IO_Write(0x96, 0x08);//enter setup DA
		//IO_Write(0x102, 0x03);//wakeup DA
		//IO_Write(0x96, 0x00);//exit setup DA
		//INT10_SetVideoMode(0x8);//for PS/55
	}
}
