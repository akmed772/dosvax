...
また、日本IBM PS/55モデル5550-S/T/Vと同等のPS/55エミュレーションを実験的に実装しています。 (PS/55はAXとは別に開発されたものなので、アーキテクチャの互換性はありません。)
...
* ビルド 4483PS17 (2025/05/28)
  - 漢字データ・ボックス バージョン 4 (Reed Rex Corp.) で画面が乱れる問題を修正しました。
* ビルド 4483PS16 (2025/03/27)
  - さまざまな PS/55 ビデオ モードでの画面サイズを修正します。
  - 以前のビルドで欠落していた依存 DLL ファイルを復元します。
* ビルド 4483PS15 (2025/03/09)
  - PS/55エミュレーションの変更
...
* ビルド 4467PS05 (2022/01/10)
  - 反転属性がセットされている位置でのカーソル色を修正
* ビルド 4467PS04 (2021/12/31)
...
* ビルド 3998AX06 (2016/10/06)
  - AX日本語モードで起動するmachine=jegaオプションを追加
  - フォントファイルパス設定名の変更
* ビルド 3998AX05 (2016/10/05)
  - 公開
