...
* Build 4481PS10 (2023/11/28)
  - IBM BASIC インタプリタまたは IBM BASIC コンパイラで構築されたグラフィック アプリケーションを実行するための DOS J4.x/J5.x 用のパッチ プログラム (dcbpatch) を追加しました。これにより、ディスプレイ構成ブロックのデータが変更され、DOSVAX でサポートされていない IBM 5550 のグラフィック支援機能が無効になります。
